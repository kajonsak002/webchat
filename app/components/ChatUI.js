    ...
    <div className="flex flex-col h-screen bg-gray-100 max-w-4xl mx-auto w-full">
      <div className="p-4 flex justify-center">
        <Button
          ...
          className={`mr-2 ${
            mode === "tokenize" ? "bg-blue-500 text-white" : "bg-gray-300"
          }`}>
          ตัดคำ
        </Button>
        <Button
          onClick={() => setMode("textqa")}
          className={`mr-2 ${
            mode === "textqa" ? "bg-blue-500 text-white" : "bg-gray-300"
          }`}>
          ถามตอบ
        </Button>
        <Button
          onClick={() => setMode("en2th")}
          className={`mr-2 ${
            mode === "en2th" ? "bg-blue-500 text-white" : "bg-gray-300"
          }`}>
          แปลเป็นไทย
        </Button>
        <Button
          onClick={() => setMode("th2en")}
          className={`${
            mode === "th2en" ? "bg-blue-500 text-white" : "bg-gray-300"
          }`}>
          แปลเป็นอังกฤษ
        </Button>
      </div>
